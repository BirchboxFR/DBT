{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set sales_tmp_tables = ['box_mono','box_sales','box_refunds','box_gift','kpi_box','box_sales_by_user_by_type','box_acquisition_daily','shop_sales','box_acquisition_detail','shop_orders_margin','shop_refunds','obj_by_country','shop_sales_with_gross_profit','box_paused','box_committed_not_paid'] -%}
