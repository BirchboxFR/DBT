{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set ops_tmp_tables = ['materialised_ruptures_longues','ops__ruptures_longues','pom_seasonality_table','bq_inventory_to_update','logistics_costs','shipping_costs','box_shipments','shop_shipments','shipments_all'] -%}
