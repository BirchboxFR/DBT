{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set marketing_tmp_tables = ['Export_predictive_ltv_per_campaign','Export_Yearly_Live','Export_GWS_LIVE','Export_Acquisition_Daily','Export_Discount_Live','live_expenses','Marketing_cac_live','Marketing_cac_expenses','Marketing_cac_budget_vs_expenses'] -%}
