{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set ops_tmp_tables = ['changement_prix_2026','materialised_ruptures_longues','ops__ruptures_longues','pom_seasonality_table','bq_inventory_to_update','logistics_costs','shipping_costs','box_shipments','shop_shipments','shipments_all'] -%}
    ...
    {%- set product_tmp_tables = ['products_lte_by_month','products_box_by_month','gws_by_month','catalog', 'algolia_product_categories', 'categories','kit_costs','all_kits','nice_names','codification_bundle_product','stock','stock_bs','stock_store','kit_details','reviews','product_classes','product_classes_3m'] -%}
    ...
    {%- set reviews_tmp_tables = ['reviews_by_user','bank_reviews'] -%}
