{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set ops_tmp_tables = ['bq_inventory_to_update','logistics_costs','shipping_costs','box_shipments','shop_shipments','shipments_all'] -%}
    ...
    {%- set inter_materialized_view_tmp_tables = ['products_detailed_rating','warehouse','user_consent','tva_product','shipup_tracking','survey_questions','survey_results','survey_Result_answers','consent','b2c_order_notifications','orders_status','consent_topic','gift_codes_generated','options','order_status','payments','postmeta','survey_answers','survey_questions','survey_result_answers','survey_results','user_consent_history','allocation_history','b2c_exported_orders','ga_transactions','mini_reexp','optin','payment_profiles','raf','raf_order_link','reception_details','reward_points_history','reward_points_history_uses','saved_cart','saved_cart_details','store_mouvements','term_relationships','trackings','user_campaign','user_mailing_list'] -%}
