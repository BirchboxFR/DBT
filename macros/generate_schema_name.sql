{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set ops_tmp_tables = ['ops__ruptures_longues','pom_seasonality_table','bq_inventory_to_update','logistics_costs','shipping_costs','box_shipments','shop_shipments','shipments_all'] -%}
    ...
    {%- set marketing_tmp_tables = ['predictive_ltv_conversion_upload','Export_predictive_ltv_per_campaign_agg','Export_predictive_ltv_per_campaign','Export_Yearly_Live','Export_GWS_LIVE','Export_Acquisition_Daily','Export_Discount_Live','live_expenses','Marketing_cac_live','Marketing_cac_expenses','Marketing_cac_budget_vs_expenses','Export_special_cost_daily'] -%}
    ...
    {%- set crm_tmp_tables = ['Export_acquisition_by_campaign','crm_acquisitions','crm_data_detailed_by_user','crm_zapier','Export_imagino_extract','optin_variations'] -%}
