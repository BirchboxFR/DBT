{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set user_tmp_tables = ['segments','today_whales','today_stars','today_spectators','today_inactive','today_lost','today_middle','today_new','today_prospects','today_risky','today_spectators'] -%}
