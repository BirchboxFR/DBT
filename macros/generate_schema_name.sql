{% macro generate_schema_name(custom_schema_name=none, node=none) -%}
    ...
    {%- set user_tmp_tables = ['customers_info_perso','customers_beauty_profile','user_consent_details','customers_streaming','splio_data_dedup','customers','today_whales','today_stars','today_spectators','today_inactive','today_lost','today_middle','today_new','today_prospects','today_risky','today_spectators','today_segments'] -%}
