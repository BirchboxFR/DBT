...
AND case when market='France' then 'FR' when market='Spain' then 'ES' when market ='Germany' then 'DE' when market ='Poland' then 'PL'  
 when market ='Sweden' then 'SE' end=b.dw_country_code
