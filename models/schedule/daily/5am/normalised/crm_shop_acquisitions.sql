...
campaign_ranked AS (
  ...
  WHERE (upper(campaign.campaign_name) LIKE '%SHOP%' or upper(campaign.campaign_name) LIKE '%LTE%' or upper(campaign.campaign_id) LIKE '%SHOP%' or upper(campaign.campaign_id) LIKE '%LTE%' )
