...
select distinct ss.user_key,year,month,ss.product_codification,ss.dw_country_code,ss.product_id, ss.product_name lte_name,lower(c.product_nice_name) product_name,  c.brand_full_name as brand_name ,user_id,c.sku,c.category_lvl_1,c.category_lvl_2,c.category_lvl_3 from sales.shop_sales ss
