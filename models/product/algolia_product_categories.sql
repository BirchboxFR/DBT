...
INNER JOIN inter.terms t1 ON t1.term_id = tx1.term_id AND tx1.dw_country_code = t1.dw_country_code
...
LEFT JOIN inter.term_taxonomy tx3 ON tx3.parent = tx2.term_id AND tx3.taxonomy = 'product-categories' AND tx3.dw_country_code = tx2.dw_country_code
...
INNER JOIN inter.terms t1 ON t1.term_id = tx1.term_id AND tx1.dw_country_code = t1.dw_country_code
LEFT JOIN inter.term_taxonomy tx2 ON tx2.parent = tx1.term_id AND tx2.taxonomy = 'product-categories' AND tx2.dw_country_code = tx1.dw_country_code
LEFT JOIN inter.terms t2 ON t2.term_id = tx2.term_id AND tx2.dw_country_code = tx2.dw_country_code
