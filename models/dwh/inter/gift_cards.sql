...
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='wp_jb_gift_cards')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='wp_jb_gift_cards')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='wp_jb_gift_cards')) -%}
...
FROM `bdd_prod_fr.wp_jb_gift_cards` t
...
FROM `bdd_prod_de.wp_jb_gift_cards` t
...
FROM `bdd_prod_es.wp_jb_gift_cards` t
...
FROM `bdd_prod_it.wp_jb_gift_cards` t
