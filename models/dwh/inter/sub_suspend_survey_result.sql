...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='sub_suspend_survey_result')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='sub_suspend_survey_result')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='sub_suspend_survey_result')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='sub_suspend_survey_result')) -%}
...
FROM `bdd_prod_fr.sub_suspend_survey_result` t
...
FROM `bdd_prod_de.sub_suspend_survey_result` t
...
FROM `bdd_prod_es.sub_suspend_survey_result` t
...
FROM `bdd_prod_it.sub_suspend_survey_result` t
