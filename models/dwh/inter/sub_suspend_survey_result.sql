...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='wp_jb_sub_suspend_survey_result')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='wp_jb_sub_suspend_survey_result')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='wp_jb_sub_suspend_survey_result')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='wp_jb_sub_suspend_survey_result')) -%}
...
FROM `bdd_prod_fr.wp_jb_sub_suspend_survey_result` t
...
FROM `bdd_prod_de.wp_jb_sub_suspend_survey_result` t
...
FROM `bdd_prod_es.wp_jb_sub_suspend_survey_result` t
...
FROM `bdd_prod_it.wp_jb_sub_suspend_survey_result` t
