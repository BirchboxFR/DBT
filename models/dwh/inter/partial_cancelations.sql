...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='partial_cancelations')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='partial_cancelations')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='partial_cancelations')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='partial_cancelations')) -%}
...
FROM `bdd_prod_fr.partial_cancelations` t
...
FROM `bdd_prod_de.partial_cancelations` t
...
FROM `bdd_prod_es.partial_cancelations` t
...
FROM `bdd_prod_it.partial_cancelations` t
