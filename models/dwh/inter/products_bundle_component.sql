...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='products_bundle_component')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='products_bundle_component')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='products_bundle_component')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='products_bundle_component')) -%}
...
FROM `bdd_prod_fr.products_bundle_component` t
...
FROM `bdd_prod_de.products_bundle_component` t
...
FROM `bdd_prod_es.products_bundle_component` t
...
FROM `bdd_prod_it.products_bundle_component` t
