...
case when datetime_diff(current_datetime(), c.created_at, hour)>1  and c.status_id in (1,2) then true else false end as  is_abandonned,
datetime_diff(current_datetime(), c.created_at, hour) as cart_age_hours,
