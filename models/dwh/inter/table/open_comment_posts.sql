...
safe_cast(end_date as date) as end_date,
  FROM `bdd_prod_fr.wp_jb_open_comment_posts` t
...
safe_cast(start_date as date) as start_date,
safe_cast(end_date as date) as end_date, FROM `bdd_prod_de.wp_jb_open_comment_posts` t
...
safe_cast(start_date as date) as start_date,
safe_cast(end_date as date) as end_date, FROM `bdd_prod_es.wp_jb_open_comment_posts` t
...
safe_cast(start_date as date) as start_date,
safe_cast(end_date as date) as end_date, FROM `bdd_prod_it.wp_jb_open_comment_posts` t
