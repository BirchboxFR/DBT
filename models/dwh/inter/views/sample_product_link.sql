{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='sample_product_link')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='sample_product_link')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='sample_product_link')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='sample_product_link')) -%}
...
FROM `bdd_prod_fr.sample_product_link` t
...
FROM `bdd_prod_de.sample_product_link` t
...
FROM `bdd_prod_es.sample_product_link` t
...
FROM `bdd_prod_it.sample_product_link` t
