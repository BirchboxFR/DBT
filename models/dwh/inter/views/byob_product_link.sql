{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='wp_jb_byob_product_link')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='wp_jb_byob_product_link')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='wp_jb_byob_product_link')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='wp_jb_byob_product_link')) -%}
...
FROM `bdd_prod_fr.wp_jb_byob_product_link` t
...
FROM `bdd_prod_de.wp_jb_byob_product_link` t
...
FROM `bdd_prod_es.wp_jb_byob_product_link` t
...
FROM `bdd_prod_it.wp_jb_byob_product_link` t
