{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='da_box_shipped_detail')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='da_box_shipped_detail')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='da_box_shipped_detail')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='da_box_shipped_detail')) -%}
...
FROM `bdd_prod_fr.da_box_shipped_detail` t
...
FROM `bdd_prod_de.da_box_shipped_detail` t
...
FROM `bdd_prod_es.da_box_shipped_detail` t
...
FROM `bdd_prod_it.da_box_shipped_detail` t
