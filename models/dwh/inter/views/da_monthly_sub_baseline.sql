{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='da_monthly_sub_baseline')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='da_monthly_sub_baseline')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='da_monthly_sub_baseline')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='da_monthly_sub_baseline')) -%}
...
FROM `bdd_prod_fr.da_monthly_sub_baseline` t
...
FROM `bdd_prod_de.da_monthly_sub_baseline` t
...
FROM `bdd_prod_es.da_monthly_sub_baseline` t
...
FROM `bdd_prod_it.da_monthly_sub_baseline` t
