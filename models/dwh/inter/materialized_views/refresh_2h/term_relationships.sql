{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='wp_term_relationships')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='wp_term_relationships')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='wp_term_relationships')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='wp_term_relationships')) -%}
...
FROM `bdd_prod_fr.wp_term_relationships` t
...
FROM `bdd_prod_de.wp_term_relationships` t
...
FROM `bdd_prod_es.wp_term_relationships` t
...
FROM `bdd_prod_it.wp_term_relationships` t
