{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='wp_postmeta')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='wp_postmeta')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='wp_postmeta')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='wp_postmeta')) -%}
...
FROM `bdd_prod_fr.wp_postmeta` t
...
FROM `bdd_prod_de.wp_postmeta` t
...
FROM `bdd_prod_es.wp_postmeta` t
...
FROM `bdd_prod_it.wp_postmeta` t
