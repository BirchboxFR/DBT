...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='order_details')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='order_details')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='order_details')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='order_details')) -%}
...
FROM `bdd_prod_fr.order_details` t
...
FROM `bdd_prod_de.order_details` t
...
FROM `bdd_prod_es.order_details` t
...
FROM `bdd_prod_it.order_details` t
