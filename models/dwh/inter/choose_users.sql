...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='choose_users')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='choose_users')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='choose_users')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='choose_users')) -%}
...
FROM `bdd_prod_fr.choose_users` t
...
FROM `bdd_prod_de.choose_users` t
...
FROM `bdd_prod_es.choose_users` t
...
FROM `bdd_prod_it.choose_users` t
