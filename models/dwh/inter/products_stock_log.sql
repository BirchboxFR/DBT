...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='products_stock_log')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='products_stock_log')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='products_stock_log')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='products_stock_log')) -%}
...
FROM `bdd_prod_fr.products_stock_log` t
...
FROM `bdd_prod_de.products_stock_log` t
...
FROM `bdd_prod_es.products_stock_log` t
...
FROM `bdd_prod_it.products_stock_log` t
