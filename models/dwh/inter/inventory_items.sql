...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='inventory_items')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='inventory_items')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='inventory_items')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='inventory_items')) -%}
...
FROM `bdd_prod_fr.inventory_items` t
...
FROM `bdd_prod_de.inventory_items` t
...
FROM `bdd_prod_es.inventory_items` t
...
FROM `bdd_prod_it.inventory_items` t
