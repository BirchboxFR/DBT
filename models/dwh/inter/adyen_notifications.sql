...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='adyen_notifications')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='adyen_notifications')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='adyen_notifications')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='adyen_notifications')) -%}
...
FROM `bdd_prod_fr.adyen_notifications` t
...
FROM `bdd_prod_de.adyen_notifications` t
...
FROM `bdd_prod_es.adyen_notifications` t
...
FROM `bdd_prod_it.adyen_notifications` t
