...
{%- set fr_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_fr', identifier='product_warehouse_location')) -%}
{%- set de_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_de', identifier='product_warehouse_location')) -%}
{%- set es_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_es', identifier='product_warehouse_location')) -%}
{%- set it_columns = adapter.get_columns_in_relation(api.Relation.create(schema='bdd_prod_it', identifier='product_warehouse_location')) -%}
...
FROM `bdd_prod_fr.product_warehouse_location` t
...
FROM `bdd_prod_de.product_warehouse_location` t
...
FROM `bdd_prod_es.product_warehouse_location` t
...
FROM `bdd_prod_it.product_warehouse_location` t
